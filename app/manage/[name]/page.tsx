  ...
  return (
    <div className="text-black flex h-full flex-col items-center justify-start bg-white">
      ...
      <div className="w-full relative">
        <div className="w-[100px] h-[100px] bg-purple-500 absolute left-[60px] -translate-y-1/2 border-4 border-white rounded-[10px]"></div>
      </div>
      <div className="flex flex-col gap-7 w-full px-[60px] border-b border-gray-200">
